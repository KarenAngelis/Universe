    ...
    return (
        <header className={styles.header}>
            <div className={styles.logo}>
                {<svg width="70" height="70" viewBox="0 0 50 42" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav>
                <ul>
                    ...
                    <li><Link to="/universe">O Universo</Link></li>
                    <li><Link to="/exploration">Exploração</Link></li>
                </ul>
            </nav>
        </header>
    );
